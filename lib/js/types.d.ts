 ...
 * @platform ios
 */
export declare enum ErrorCodeIOS {
}
/**
 * Android 错误代码
 *
 * @platform android
 */
export declare enum ErrorCodeAndroid {
    /**
     * 定位成功
     */
    LOCATION_SUCCESS = 0,
 ...
 * @platform android
 */
export declare enum LocationPurpose {
    /**
     * 签到场景
     *
 ...
 * 逆地理编码语言
 */
export declare enum GeoLanguage {
    /**
 ...
 * @platform android
 */
export declare enum GpsAccuracy {
    UNKNOWN = 0,
    BAD = 1,
    GOOD = 2
}
 ...
 * 定位结果的可信度
 */
export declare enum TrustedLevel {
    HIGH = 1,
    NORMAL = 2,
    LOW = 3,
    BAD = 4
